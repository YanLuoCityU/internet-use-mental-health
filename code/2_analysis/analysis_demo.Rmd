...
load(str_c(getwd(), "/data/demo/demo_data.RData"))
...
# You can modify the "dpi" parameter to generate the figure with higher resolution
ggsave(str_c(getwd(), "/results/Figure (demo)/Figure 1_Forest plot_internet use.tiff"), plot = p_pool, width = 16, height = 14, unit = "in", dpi = 100, device = "tiff")
...
ggsave(str_c(getwd(), "/results/Figure (demo)/Figure 2_Bubble plot.tiff"), plot = p_pool_bubble, width = 12, height = 24, unit = "in", dpi = 100, device = "tiff")
...
ggsave(str_c(getwd(), "/results/Figure (demo)/Figure 3_Heatmap.tiff"), plot = heatmap_pool, width = 16, height = 26, unit = "in", dpi = 100, device = "tiff")
...
ggsave(str_c(getwd(), "/results/Figure (demo)/Figure 4_Forest plot_internet use and depressive symptoms pgs.tiff"), plot = p_pool, width = 20, height = 12, unit = "in", dpi = 100, device = "tiff")
...
ggsave(str_c(getwd(), "/results/Figure (demo)/Extended Data Figure 4_Forest plot_internet use and well-being pgs.tiff"), plot = p_pool, width = 20, height = 12, unit = "in", dpi = 100, device = "tiff")
...
tbl %>%
  as_flex_table() %>%
  flextable::save_as_docx(path = str_c(getwd(), "/results/Table (demo)/Supplementary Table 4_Baseline characteristics by countries_pgs.docx"))
...
ggsave(str_c(getwd(), "/results/Figure (demo)/Figure 5_Forest plot_cumulative internet use.tiff"), plot = p_pool, width = 16, height = 12, unit = "in", dpi = 100, device = "tiff")
...
tbl %>%
  as_flex_table() %>%
  flextable::save_as_docx(path = str_c(getwd(), "/results/Table (demo)/Supplementary Table 2_Baseline characteristics by countries_cumulative internet use.docx"))
...
ggsave(str_c(getwd(), "/results/Figure (demo)/Figure 6_Forest plot_internet use frequency.tiff"), plot = p_pool, width = 13, height = 8, unit = "in", dpi = 100, device = "tiff")
...
ggsave(str_c(getwd(), "/results/Figure (demo)/Supplementary Figure 1_Forest plot_internet use frequency_unadjusted.tiff"), plot = p_pool, width = 13, height = 8, unit = "in", dpi = 100, device = "tiff")
...
tbl %>%
  as_flex_table() %>%
  flextable::save_as_docx(path = str_c(getwd(), "/results/Table (demo)/Supplementary Table 3_Baseline characteristics by countries_internet use frequency.docx"))
...
write.csv(dat_comp_all, file = str_c(getwd(), "/results/Table (demo)/Supplementary Table 5_Subgroup analyses by internet use measures.csv"))
...
ggsave(str_c(getwd(), "/results/Figure (demo)/Extended Data Figure 2_Bar plot_internet use prevalence by country.tiff"), plot = p_internet_pre, width = 6, height = 12, unit = "in", dpi = 100, device = "tiff")
...
ggsave(str_c(getwd(), "/results/Figure (demo)/Extended Data Figure 3_Dot plot_correlation.tiff"), plot = p_pool_dot, width = 12, height = 12, unit = "in", dpi = 100, device = "tiff")
...
tbl %>%
  as_flex_table() %>%
  flextable::save_as_docx(path = str_c(getwd(), "/results/Table (demo)/Supplementary Table 1_Baseline characteristics by countries_internet use.docx"))
...
tbl_wave %>%
  as_flex_table() %>%
  flextable::save_as_docx(path = str_c(getwd(), "/results/Table (demo)/Supplementary Table 1_Baseline survey year by countries_internet use.docx"))
